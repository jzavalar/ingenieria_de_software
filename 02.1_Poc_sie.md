...
## Hipotético Sistema de Información Escolar (SiE)**
**Version 0.1**
...
### **Base del Sistema:** **Rocky Linux**: Sistema operativo empresarial (servidor base para todos los servicios)
...
- Examen de admisión (licenciatura), evaluación académica (posgrado) 
- Asignación de lugares
- Generación de documentos de aceptación (posgrado)
- Reportes estadísticos de admisión

#### **Módulo de Inscripción**
- Inscripción o alta de nuevos alumnos
- **Credencialización inicial**:
  - Captura de fotografía y firma digital
  - Validación de formato y calidad de imagen
  - Generación de credencial de alumno
  - Datos de credencial: fotografía, matrícula, carrera, vigencia, código QR o de barras
...
- **Captura de calificaciones** y **firma de acta** por profesores
- Cierre de trimestre
